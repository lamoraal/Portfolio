...
const displayMovie = (movieInfo, castInfo) => {
    ...
    const movieCast = createMovieCast(`Lead: ${castInfo.cast[0].name} as ${castInfo.cast[0].character}<br>With: ${castInfo.cast[1].name} as ${castInfo.cast[1].character}<br>And: ${castInfo.cast[2].name}
    as ${castInfo.cast[2].character}`);
